...
# # cleanup
# unlink(file.path(vcr_configuration()$dir, "test_write_to_disk_binary_httr.yml"))


# # reset configuration
vcr_configure_reset()

# cas <- insert_cassette("test_write_to_disk_binary_img_fxn")
