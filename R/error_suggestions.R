error_suggestions <- list(
  use_new_episodes = list(
    ...
    url = "https://ropenscilabs.github.io/http-testing-book/record-modes.html#new_episodes"
  ),
  ...
  delete_cassette_for_once = list(
    text = c("The current record mode ('once') does not allow new requests to be recorded",
     ...
     url = "https://ropenscilabs.github.io/http-testing-book/record-modes.html#once"
  ),
  ...
  deal_with_none = list(
    text = c("The current record mode ('none') does not allow requests to be recorded. You",
     ...
     url = "https://ropenscilabs.github.io/http-testing-book/record-modes.html#none"
  ),
  ...
  use_a_cassette = list(
    ...
    url = "https://ropenscilabs.github.io/http-testing-book/intro"
  ),
  ...
  allow_http_connections_when_no_cassette = list(
    ...
    url = "https://ropenscilabs.github.io/http-testing-book/vcr-configuration#allow-http-connections-when-no-cassette"
  ),

  ignore_request = list(
    text = c("If you want vcr to ignore this request (and others like it), you can",
     "set an `ignore_request` function"),
    url = "https://ropenscilabs.github.io/http-testing-book/vcr-configuration#config-ignore-requests"
  ),
  ...
  allow_playback_repeats = list(
    text = c("The cassette contains an HTTP interaction that matches this request,",
     ...
     "cassette option"),
    url = "https://ropenscilabs.github.io/http-testing-book/request-matching#playback-repeats"
  ),
  ...
  match_requests_on = list(
    text = c("The cassette contains %s not been",
     ...
     url = "https://ropenscilabs.github.io/http-testing-book/request-matching"
  ),
  ...
  try_debug_logger = list(
    ...
    url = "https://ropenscilabs.github.io/http-testing-book/logging"
  )
)
