...
Lets look at logging to see what happens the first time you make a request:
...
1. First a new cassette is inserted with recording turned on.
Then it handles a request, recording it to disk.
3. Finally the cassette is ejected.
